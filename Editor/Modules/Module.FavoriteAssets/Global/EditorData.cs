...
namespace Kinogoblin.Editor.FavoriteAssets
{
    ...
    public class EditorData : ScriptableObject
    {
        ...
        private static EditorData m_instance;
        ...
        {
            //LOGO ON WINDOW
            string[] configData = AssetDatabase.FindAssets("EditorData t:" + typeof(EditorData).ToString(), null);
            if (configData.Length >= 1)
            {
                return AssetDatabase.LoadAssetAtPath(AssetDatabase.GUIDToAssetPath(configData[0]), typeof(EditorData)) as EditorData;
            }
    ...
    public class ConfigurableIcon
    {
        ...
        {
            EditorData.OnEditorDataRefresh += onEditorDataRefresh;
        }
